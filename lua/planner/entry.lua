...
--- @param ent Entry
--- @return string
M.to_html = function(ent)
	local ret = ""
	if ent.category ~= nil or ent.category ~= nil then
		ret = ret .. "<p><b>"
		if ent.category ~= nil then
			ret = ret .. title_case(ent.category)
			if ent.summary ~= nil then
				ret = ret .. ": "
			end
		end
		if ent.summary ~= nil then
			ret = ret .. title_case(ent.summary)
		end
		ret = ret .. "</b></p>"
	end
	ret = ret
		.. "<p>" .. title_case(ent.description) .. "</p>"
		.. "<p>More Info:</p>"
		.. "<table>"
		.. "<tr><td><b>Scheduled Time (epoch time)</b></td><td>" .. ent.due .. "</td></tr>"
		.. "<tr><td><b>Raw String (what was written)</b></td><td><code>" .. ent.raw .. "</code></td></tr>"
		.. "<tr><td><b>Duration of the Event (epoch seconds)</b></td><td>" .. (ent.duration or "0 (none)") .. "</td></tr>"
		.. "</table>"
